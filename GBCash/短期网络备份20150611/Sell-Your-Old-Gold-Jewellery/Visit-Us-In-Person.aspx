<%@ page language="C#" autoeventwireup="true" inherits="Sell_Your_Old_Gold_Jewellery_Visit_Us_In_Person, App_Web_megxcffm" enableviewstatemac="false" %>
...
<head runat="server">
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Visit Us In Person</title>
    ...
    <div id="main">
        <div>
          <div id="content" style="margin: 15px; float: left; padding: 5px 0 0 10px; width: 620px">
                ...
                <p><strong><strong>You can visit our office or sell your items online from the comfort and privacy of your home</strong>. </strong>Simply fill in the form on this page and we will send you your free Gold Pack. The pack contains all the information you need to sell your old gold and jewellery for cash.
</p>
                <p>&nbsp;</p>
                <h1><strong>Visit Us In Person </strong> </h1>
                <div>                  
                  <p>We are dedicated to making sure your gold trade <sup></sup> experience with Golden Bridge Finance is enjoyable. We would love to serve you in person in our comfortable and private office in Melbourne. Just bring in your items and we will provide you with absolutely FREE and NO obligation analysis and quote.</p>
                  <p>&nbsp;</p>
                  <h1 class="style1">Call 1300 137 906 to make an appointment. </h1>
                  <p><strong>Our customer service hours are </strong>: </p>
                  <p>Monday - Friday: 9:00 a.m. - 5:30 p.m. EST</p>
                  <p>Exclude weekends &amp; public holidays in Victoria.</p>
                  <p>&nbsp;</p>
