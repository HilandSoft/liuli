					...
					<tr>
						<td align="center"><asp:panel id="Panel4" runat="server" Width="392px" Visible="False" Height="208px">
								<TABLE border="0" cellSpacing="0" cellPadding="0" width="390">
									...
									<TR>
										<TD colSpan="3">
											<DIV style="BORDER: black 1px solid;  HEIGHT: 150px; OVERFLOW: auto;"
												id="divAgreement">&nbsp;&nbsp;By typing my name below, I am applying for a new online cash loan and certify that this information is true and correct under penalty of perjury. I authorize Golden Bridge Cash Solution to verify the information I have provided, and to be bound by the terms of the Master Loan Agreement that I signed with my initial loan application. I agree that the payment schedule set above is not in dispute and that I have full capacity to consent to the payment of such amount.
												<BR>
												&nbsp;&nbsp;In the event of default, I agree to pay all applicable penalties including a $25.00 Returned Item Fee, and if the balance is not paid within 5 days following its scheduled Due Date, to pay an additional $50 Late Fee. 
												<BR>
												&nbsp;&nbsp;I understand that a Debt Collection Fee calculated to be 50% of the total amount owing will be added to my outstanding amount if my account is passed on to professional Debt Collection Agency. I understand that if I let any of my payments 'bounce', I authorize Golden Bridge Cash Solution to access my account until all loans, fees and penalties are recovered.</DIV>
										</TD>
									</TR>
									<TR>
										<TD colSpan="3"></TD>
