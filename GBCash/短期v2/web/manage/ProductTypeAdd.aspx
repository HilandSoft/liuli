<%@ Page language="c#" Codebehind="ProductTypeAdd.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.ProductTypeAdd" %>
<HTML>
	<HEAD>
		<title>
			<%=WebAppTitle%>
										...
										<tr>
											<td>
												<table width="100%" height="100%">
													<tr>
														<td height="30" align="center" style='FONT-SIZE:16px'>添 加 类 别</td>
													</tr>
													<tr>
													...
													<tr>
														<td height="200" width="400" valign="top" align="center"><table>
																<tr>
																	...
																	<td><asp:TextBox id="TextBox1" runat="server" Width="240px" CssClass="iinput"></asp:TextBox></td>
																</tr>
																<tr>
