<%@ Page language="c#" Codebehind="ProductEdit.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.ProductEdit" %>
<HTML>
	<HEAD>
		<title>
			<%=WebAppTitle%>
													...
													<tr>
														<td height="200" width="400" valign="top" align="center"><table>
																<tr>
																	...
																	<td>
																		<asp:TextBox id="TextBox1" runat="server" CssClass="iinput" Width="176px" DESIGNTIMEDRAGDROP="102"></asp:TextBox>
																		<asp:CheckBox id="CheckBox2" runat="server" Font-Size="12px" Text="推荐"></asp:CheckBox></td>
																</tr>
																<TR>
