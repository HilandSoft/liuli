    ...
    public class MainTop : ManageBasePage
    {
        ...
        private void ShowMenu()
        {
            ...
            if (base.SystemUserID != 0)
            {
                ...
                builder.AppendFormat(format, "d0", "<a href='javascript:jumps(\"AdminList.aspx\")'>ManagerList </a>");
                builder.AppendFormat(format, "d1", "<a href='javascript:jumps(\"../SystemInfo.aspx\")'>ShortParamSetting </a>");
                builder.AppendFormat(format, "d2", "<a href='javascript:jumps(\"../long/ParamsSet.aspx\")'>LongParamSetting </a>");
