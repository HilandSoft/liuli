namespace YingNet.WeiXing.WebApp.manage
{
    ...
    public class ScheduleDel : ManageBasePage
    {
        ...
        private void Page_Load(object sender, EventArgs e)
        {
            ...
            str2 = datedue.ToString(Config.DateRecordFormat);
            dt.IsValid = 3;
            ebn.Edit(dt);
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                string commandText = string.Concat(new object[] { "update Schedule set Balance=Balance-", num2.ToString(), " where id=", edt2.id, " and Balance>0 and Datedue>'", str2, "'" });
