	...
	<body bgColor="#ffffff" leftMargin="0" topMargin="0" MARGINHEIGHT="0" MARGINWIDTH="0">
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="650" align="center" border="0">
				...
				<tr>
					<td align="center"><strong>Please READ, SIGN, and FAX back to: 1300 138 916 or email to</strong> <a href="mailto:apply@cashsolution.com.au"><strong>apply@gbcash.com.au</strong></a></td>
				</tr>
				<tr>
					<td align="center" height="10">
						<span class="unnamed2">
								 If you have any questions contact our Customer Service E-mail Address 
								at <strong><a href="mailto:lily110810@yahoo.com">info@gbcash.com.au </a></strong>
						...
						<table cellSpacing="0" cellPadding="0" width="650" border="0">
							...
							<tr>
							  ...
							  <td>&nbsp; <INPUT id="HomeAddress1" style="BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none"
										readOnly type="text" name="textfield" runat="server" size="40"></STRONG>							    <input id="HomeAddress2" style="BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none"
				...
				<tr>
					<td>
						...
						<table cellSpacing="0" cellPadding="0" border="1" bordercolor="#000000">
							...
							<tr class="unnamed2">
							  <td vAlign="top" colSpan="5"><span class="unnamed1"><strong>Finance cost</strong> includes establishment fee 20% and monthly fee 4% of the loan amount.</span></td>
						  </tr>
							<tr class="unnamed2">
								<td vAlign="top" colSpan="5">
									<p class="unnamed1"><STRONG>Charges may become payable</STRONG><br>
...
Collection Fee: 50% of outstanding debt</p>							  </td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td class="unnamed1"><strong>PROMISE TO PAY</strong> For value received, I promise to pay to Bridge 
						...
						have full capacity to consent to the payment of such amount. <br>
...
I promise to keep open and maintain an adequate balance in my account to ensure 
						...
						days after the scheduled due date(s), until this note is paid in full. <br>
						...
						agreements to extend the due date of a loan or to apply a new loan. <br>
						...
						Victoria in Australia, and Victoria State Law shall govern all aspects thereof. <br>
				...
				<tr>
					<td>
						<table cellSpacing="0" cellPadding="0" width="650" border="0">
							...
							<tr>
								<td colspan="2" align="center" height="24"><p align="center" class="unnamed1">Golden Bridge Enterprises (Aust) Pty Ltd (ABN: 92 112 483 226 ACL No. 388601)  PO Box 347, Collins Street West, VIC 8007<br>
