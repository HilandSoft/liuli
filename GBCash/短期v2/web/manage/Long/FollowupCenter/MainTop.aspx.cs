    ...
    public class MainTop : ManageBasePage
    {
        ...
        private void ShowMenu()
        {
            ...
            if (base.SystemUserID != 0)
            {
                ...
                builder.AppendFormat(format, "a0", "<a href='javascript:jumps(\"../../MainHome.aspx\")'>Home&nbsp;&nbsp;");
                builder.AppendFormat(format, "b0", "<a href='javascript:jumps(\"FollowupStat.aspx\")'>Stat&nbsp;&nbsp;");
