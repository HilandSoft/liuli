<%@ Page language="c#" Codebehind="ProcessInfo.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.ProcessCenter.ProcessInfo" %>
			...
			<table cellSpacing="0" cellPadding="1" width="70%" align="center" border="0">
				<tr>
					<td colSpan="2" height="25">&nbsp;
						<asp:textbox id="txSid" runat="server" Visible="False" Width="40px"></asp:textbox><asp:textbox id="txPerSid" runat="server" Visible="False" Width="40px"></asp:textbox>CurrentMemberID:
				...
				<tr>
					<td colSpan="2">
						...
						<div>&nbsp;<asp:button id="btnSendForPreApproval" runat="server" Text="Save"></asp:button></div>
					</td>
				</tr>
				<tr>
					<td height="25"></td>
						...
						<div align="left">
							<table cellSpacing="0" cellPadding="1" width="90%" border="1">
								...
								<tr>
									...
									<td align="left"><asp:textbox id="tbNextPaydayDD" Width="24px" Runat="server"></asp:textbox>/
				...
				<tr>
					<td colSpan="2"><asp:textbox id="ConversationTrack" Width="552px" Runat="server" Height="82px" TextMode="MultiLine"></asp:textbox>
						<asp:button id="btnSave" runat="server" Text="SaveConversation" CssClass="commonImageTextButton"></asp:button><asp:hyperlink id="HyperLink1" runat="server" NavigateUrl="ProcessList.aspx" CssClass="commonImageTextButton">Exit Without Saving</asp:hyperlink></td>
				</tr>
			</table>
		</form>
	</body>
