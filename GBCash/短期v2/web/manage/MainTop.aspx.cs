    ...
    public class MainTop : ManageBasePage
    {
        ...
        private void ShowMenu()
        {
            ...
            if (base.SystemUserID != 0)
            {
                ...
                builder.AppendFormat(format, "a7", " <a href='javascript:jumps(\"MemberList.aspx\")'> MemberList </a>");
                builder.AppendFormat(format, "a3", " <a href='javascript:jumps(\"agreeinput.aspx\")'> Agreement </a>");
