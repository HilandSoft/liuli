<%@ Register TagPrefix="cc2" Namespace="YingNet.WeiXing.WebApp.UserControls" Assembly="YingNet.Common" %>
...
.word2 { FONT-SIZE: 12px; COLOR: #cc3300; TEXT-DECORATION: none }
	...
	<body LEFTMARGIN="0" TOPMARGIN="0" MARGINWIDTH="0" MARGINHEIGHT="0">
		<form id="Form1" method="post" runat="server">
						...
						<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
							<TR>
								<TD colSpan="4" height="30" bgcolor="#cc3300">
									...
									<asp:TextBox id="txLoanSid" runat="server" Width="100px" Visible="False"></asp:TextBox></TD>
							</TR>
							<tr>
								<td colspan="2" height="10" width=261></td>
							</tr>
							<TR>
							...
							<TR>
								<TD width="15%" height="30">Street no. and name:</TD>
								<TD width="143"><INPUT id="txStreet" type="text" style="WIDTH:120px" name="textfield22322522" runat="server">
									<FONT color="#ff0000">*</FONT></TD>
								<TD width="8%">Suburb :</TD>
								<TD><INPUT id="txSuburb" type="text" style="WIDTH:120px" name="textfield223225224" runat="server">
									<FONT color="#ff0000">*</FONT></TD>
							</TR>
							<TR>
								<TD height="30">State :</TD>
								<TD width=143><cc2:AustralianStateDropDownList id="AustralianStateDropDownList" runat="server"></cc2:AustralianStateDropDownList>
									<FONT color="#ff0000">*</FONT></TD>
								<TD>Postcode :</TD>
								<TD><INPUT id="txPost" type="text" style="WIDTH:120px" name="textfield223225224" runat="server">
									<FONT color="#ff0000">*</FONT><span class="style1"> Please note that the loans are currently not available for the residents in QLD.. </span></TD>
							</TR>
							<TR>
								<TD colSpan="4" align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
            ...
            <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
              <TR>
                <TD height=30><B>Previous Residential Details</B> </TD></TR>
              <TR>
                <TD>
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    <TR>
                      <TD width="30%" height=30>Unit / Apartment No : </TD>
                      <TD><INPUT id=txUnitNo1 style="WIDTH: 150px" type=text 
                        name=textfield2232242 runat="server"> 
                  </TD></TR></TABLE></TD></TR>
              <TR>
                <TD>
                  <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                    <TR>
                      <TD height=30>Street no. and name:</TD>
                      <TD><INPUT id=txStreet1 style="WIDTH: 150px" type=text 
                        name=textfield22322522 runat="server"> <FONT 
                        color=#ff0000>*</FONT></TD>
                      <TD>Suburb :</TD>
                      <TD><INPUT id=txSuburb1 style="WIDTH: 150px" type=text 
                        name=textfield223225224 runat="server"> <FONT 
                        color=#ff0000>*</FONT></TD></TR>
                    <TR>
                      <TD height=30>State :</TD>
                      <TD>
<cc2:AustralianStateDropDownList id=AustralianStateDropDownList1 runat="server"></cc2:AustralianStateDropDownList><FONT 
                        color=#ff0000>*</FONT>Please note that the loans are 
                        currently not available for the residents in QLD.</TD>
                      <TD>Postcode :</TD>
                      <TD><INPUT id=txPost1 style="WIDTH: 150px" type=text 
                        name=textfield223225224 runat="server"> <FONT 
                        color=#ff0000>*</FONT></TD></TR>
                    <TR>
...
border=0>
                          <TR>
                            ...
                            <TD><SELECT id=txYear1 style="WIDTH: 120px" 
                              name=select5 runat="server"> <OPTION value=0 
                                selected>0</OPTION> <OPTION value=1>1</OPTION> 
                                <OPTION value=2>2</OPTION> <OPTION 
                                value=3>3</OPTION> <OPTION value=4>4</OPTION> 
                                ...
                                value="12 or above">12 or above</OPTION></SELECT> 
                              Years <SELECT id=txMonth1 style="WIDTH: 120px" 
                              name=select5 runat="server"> <OPTION value=0 
                                selected>0</OPTION> <OPTION value=1>1</OPTION> 
                                <OPTION value=2>2</OPTION> <OPTION 
                                value=3>3</OPTION> <OPTION value=4>4</OPTION> 
                                ...
                                value=9>9</OPTION> <OPTION value=10>10</OPTION> 
                                <OPTION value=11>11</OPTION> <OPTION 
                                value=12>12</OPTION></SELECT> Months 
