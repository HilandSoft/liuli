<%@ Page language="c#" Codebehind="ProductLeft.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.ProductLeft" %>
<html>
	<head>
...
function prepareData()
{
    ...
    obj.DataURL             ="1.txt" // "ProductGetLeftData.aspx";
    obj.UseHeader           = true;
    obj.CaseSensitive       = false;
    obj.CharSet             = "utf-8";
    obj.EscapeChar          = "\\";

    obj.setAttribute( "is_ready", "false" );
    data_src = obj;
	destroy();
    init();
}
...
function Reset()
{
	if (data_src!=null)
	{
		var url = "ProductGetLeftData.aspx";
...
//-->
	...
	<body onLoad="prepareData()" style="border:0px;margin:0px">
		<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" bgcolor="#C5DDFF"
			style="BORDER: #336699 1px solid; " ID="Table1">
			<tr>
				<td bgcolor="#93BBF1" height="25" style="BORDER-BOTTOM: #336699 1px solid;font-size:12px">&nbsp;类别列表：</td>
			</tr>
			<tr>
				<td class="td1"><div id="excel" style="OVERFLOW-Y: auto;OVERFLOW-X: auto;width:100%; HEIGHT: 100%;SCROLLBAR-FACE-COLOR: #dee3e7;SCROLLBAR-HIGHLIGHT-COLOR: #ffffff; SCROLLBAR-SHADOW-COLOR: #dee3e7; SCROLLBAR-3DLIGHT-COLOR: #d1d7dc; SCROLLBAR-ARROW-COLOR: #006699; SCROLLBAR-TRACK-COLOR: #efefef; SCROLLBAR-DARKSHADOW-COLOR: #98aab1;"><span id="wait_tip" style="BORDER-TOP:#336699 1px solid;PADDING-RIGHT: 20px; DISPLAY: none; PADDING-LEFT: 20px; FONT-SIZE: 12px; PADDING-BOTTOM: 20px; COLOR: #999999; PADDING-TOP: 20px">正在调入数据, 
							请等待...</span>
