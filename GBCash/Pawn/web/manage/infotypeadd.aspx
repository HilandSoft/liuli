<%@ Page language="c#" Codebehind="infotypeadd.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.infotypeadd" %>
<HTML>
	<HEAD>
		<title>
			<%=WebAppTitle%>
				...
				<tr>
					<td colSpan="3">
						<table id="Table2" style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; FONT-SIZE: 12px; BORDER-LEFT: 0px; BORDER-BOTTOM: 0px; BORDER-COLLAPSE: collapse"
							...
							<tr>
								<td>
									<div id="Div1" style="OVERFLOW-Y: auto; SCROLLBAR-FACE-COLOR: #dee3e7; SCROLLBAR-HIGHLIGHT-COLOR: #ffffff; WIDTH: 100%; SCROLLBAR-SHADOW-COLOR: #dee3e7; SCROLLBAR-3DLIGHT-COLOR: #d1d7dc; SCROLLBAR-ARROW-COLOR: #006699; SCROLLBAR-TRACK-COLOR: #efefef; SCROLLBAR-DARKSHADOW-COLOR: #98aab1; HEIGHT: 100%"><FONT face="宋体"></FONT><FONT face="宋体"></FONT><FONT face="宋体"></FONT><FONT face="宋体"></FONT><br>
										<br>
																	...
																	<tr>
																		<td height="100" width="400" valign="top" align="center"><table>
																				<tr>
																					...
																					<td><FONT face="宋体">
																							<asp:TextBox id="TextBox1" runat="server" Width="208px" CssClass="iinput"></asp:TextBox></FONT></td>
																				</tr>
																			</table>
																		</td>
																	</tr>
