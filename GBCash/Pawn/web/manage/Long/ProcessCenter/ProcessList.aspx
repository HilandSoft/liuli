<%@ Page language="c#" Codebehind="ProcessList.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.Long.ProcessCenter.ProcessList" %>
				...
				<tr>
					<td vAlign="top"><cc1:datagridtable id="DataGridTable1" runat="server" Width="100%" BorderStyle="None" BorderWidth="1px"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="DocumentState">
									<HeaderStyle></HeaderStyle>
									<HeaderTemplate>
										DocumentState
									</HeaderTemplate>
