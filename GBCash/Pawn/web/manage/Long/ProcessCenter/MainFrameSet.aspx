<%@ Page language="c#" Codebehind="MainFrameSet.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.Long.ProcessCenter.MainFrameSet" %>
<html>
	<head>
		<title>WebSite </title>
	...
	<frameset rows="109,*" border="0" frameSpacing="0" frameBorder="0">
		...
		<frame name="main" src="../../MainHome.aspx" scrolling="auto">
		<noframes>
			<p id="p1">
