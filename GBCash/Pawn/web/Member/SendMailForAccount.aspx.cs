		...
		private void Submit1_ServerClick(object sender, System.EventArgs e)
		{
			try
			{
				...
				if(gotenUserPassword!=string.Empty&& gotenUserAccount!=string.Empty)
				{
					...
					sbBody.Append("<br/>");
					sbBody.Append("<br/>");
					sbBody.Append("Please do not reply to this email. If you need any further assistant, please do not hesitate to contact us at 1300 137 906 or email at <a href='mailto:info@cashsolution.com.au'>info@cashsolution.com.au</a>. You can also visit our web site at <a href='http://www.cashsolution.com.au'>www.cashsolution.com.au</a> for more information.");
					sbBody.Append("<br/>");
					sbBody.Append("<br/>");
					sbBody.Append("<br/>");
