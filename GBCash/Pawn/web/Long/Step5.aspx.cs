namespace YingNet.WeiXing.WebApp.Long
{
    ...
    public class Step5 : LongParent
    {
        ...
        {
			this.dlrestatus.SelectedIndexChanged += new System.EventHandler(this.dlrestatus_SelectedIndexChanged);
			...
			this.bnApption.Click += new System.EventHandler(this.bnApption_Click);
			this.bnEdit1.ServerClick += new System.EventHandler(this.bnEdit1_ServerClick);
			this.bnInit.ServerClick += new System.EventHandler(this.bnInit_ServerClick);
			this.bnEdit2.ServerClick += new System.EventHandler(this.bnEdit2_ServerClick);
			this.Submit2.ServerClick += new System.EventHandler(this.Submit2_ServerClick);
			this.bnEdit3.ServerClick += new System.EventHandler(this.bnEdit3_ServerClick);
			this.bnEmploy.ServerClick += new System.EventHandler(this.bnEmploy_ServerClick);
			this.bnEdit4.ServerClick += new System.EventHandler(this.bnEdit4_ServerClick);
			this.bnBank.ServerClick += new System.EventHandler(this.bnBank_ServerClick);
