<%@ Page language="c#" autoeventwireup="false" inherits="YingNet.WeiXing.WebApp.Sell_Your_Old_Gold_Jewellery.Today_Prices" enableviewstatemac="false" CodeBehind="Today-Prices.aspx.cs" %>
...
<body>
 ...
 <p>Pricing your gold jewellery depends on several factors.</p>
                ...
                <div style="padding: 1px 5px 5px 35px; font-family: Georgia, 'Times New Roman' , Times, serif">
                    <ul>
                        <li>24ct is pure Gold at 99.99% </li>
                        <li>22ct gold equals 91.6% purity (reflecting a combination of other metals)</li>
                        <li>18ct gold equals 75% purity (reflecting a combination of other metals)</li>
                        <li>14ct gold equals 58.5% purity (reflecting a combination of other metals)</li>
                        <li>9ct gold equals 37.5% purity (reflecting a combination of other metals)</li>
                    </ul>
                </div>   
