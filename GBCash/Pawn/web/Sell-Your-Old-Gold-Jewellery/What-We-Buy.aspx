<%@ Page language="c#" autoeventwireup="false" inherits="YingNet.WeiXing.WebApp.Sell_Your_Old_Gold_Jewellery.What_We_Buy" enableviewstatemac="false" CodeBehind="What-We-Buy.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
   <title>What We Buy</title>
...
.style2 {padding:14px 0 17px 0; margin: 0;}
-->
    </style>
</head>
<body>
    ...
    <div id="main">
        <div>
            <div id="content" style="margin: 15px; float: left; padding: 5px 0 0 10px; width: 620px">
                ...
                <div><span class="gallery-main">                
                  <h1><a href="#"> </a> <a href="#"> </a> </h1>
                  <h1><span class="ui-datepicker-group-middle style1">Buy gold, silver, platinum or all 9-24 carat jewellery</span></h1>
                </span></div>
                <div> 
                  <p>Golden Bridge Finance is Australia's leading gold buying and financing company. We are using the XRF-based (X-Ray Fluorescence) precious metal testing machine for your item analysis. The absolute accuracy of this technology allows you to trade with confidence and efficiency.</p>
                  <p>&nbsp;</p>
                </div>
                <div align="left"><h1><strong>What we buy</strong></h1>
                </div>
                <p>Here are some examples of what we buy:</p>
                <p>&nbsp;                </p>
                <ul>
              ...
              <p>&nbsp;</p>
              <p><strong><strong>You can visit our office or sell your items online from the comfort and privacy of your home</strong>. </strong>Simply fill in the form on this page and we will send you your free Gold Pack. The pack                            contains all the information you need to sell your old gold and jewellery for cash.</p>
              <p> </p>
