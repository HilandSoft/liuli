				...
				<TBODY>
					<TR>
						<TD><asp:panel id="Panel5" runat="server" Width="344px">
								<TABLE style="WIDTH: 397px; HEIGHT: 56px" cellSpacing="0" cellPadding="0" width="397" border="0">
									<TR>
								...
								<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="397" border="0">
									...
									<TR>
										...
										<TD colSpan="3"><INPUT id="txEmployer" size="32" name="textfield2922" runat="server">
											<FONT face="宋体" color="#990000">*</FONT></TD>
									</TR>
									<TR>
									...
									<TR>
										...
										<TD colSpan="3"><INPUT id="txPhone" size="32" name="textfield2924" runat="server"> <FONT face="宋体" color="#990000">
												*</FONT></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 153px">Job Title:</TD>
										<TD colSpan="3"><INPUT id="txJob" size="32" name="textfield2924" runat="server"> <FONT face="宋体" color="#990000">
												*</FONT></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 153px">Time Employed:
										</TD>
										<TD colSpan="3"><SELECT id="txYear" name="select2" runat="server"><OPTION value="0" selected>0</OPTION>
									...
									<TR>
										...
										<TD colSpan="3">$<INPUT id="txIncome" size="12" name="textfield29242" runat="server">.00<FONT face="宋体" color="#990000">
												<FONT face="宋体" color="#990000">*</FONT></FONT></TD>
									</TR>
									<TR>
									...
									<TR>
										...
										<TD colSpan="3">DD <INPUT id="txDd1" size="2" name="textfield29243" runat="server"> 
											MM <INPUT id="txMm1" size="2" name="textfield292432" runat="server"> YYYY <INPUT id="txYy1" size="4" name="textfield292433" runat="server"><FONT face="宋体" color="#990000">*</FONT></TD>
									</TR>
									<TR>
						...
						<td><asp:panel id="Panel2" runat="server" Width="380px" Visible="False">
								<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="397" border="0">
									...
									<TR>
										...
										<TD colSpan="3"><INPUT id="txType" size="22" name="textfield2925" runat="server"><FONT face="宋体" color="#990000">*</FONT></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 162px">Centrelink Office:</TD>
										<TD colSpan="3"><INPUT id="txOffice" size="22" name="textfield29222" runat="server"><FONT face="宋体" color="#990000">*</FONT></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 162px">Contact Telephone Number:</TD>
										<TD colSpan="3"><INPUT id="txContact" size="22" name="textfield29232" runat="server"><FONT face="宋体" color="#990000">*</FONT></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 162px; HEIGHT: 22px">How long on this benefit:
										</TD>
										<TD style="HEIGHT: 22px" colSpan="3"><SELECT id="txYear2" name="select2" runat="server"><OPTION value="0" selected>0</OPTION>
												<OPTION value="1">1</OPTION>
												<OPTION value="2">2</OPTION>
												<OPTION value="3">3</OPTION>
												<OPTION value="4">4</OPTION>
									...
									<TR>
										...
										<TD colSpan="3"><FONT face="宋体" color="#990000">$</FONT><INPUT id="txBenefit" size="15" name="textfield2924222" runat="server"><FONT face="宋体" color="#990000">.00
												<FONT face="宋体" color="#990000">*</FONT></FONT><FONT face="宋体" color="#990000"></FONT></TD>
									</TR>
									<TR>
									...
									<TR>
										...
										<TD colSpan="3">DD <INPUT id="txDd4" style="WIDTH: 40px; HEIGHT: 22px" size="1" name="textfield292436" runat="server">
											MM <INPUT id="txMm4" style="WIDTH: 40px; HEIGHT: 22px" size="1" name="textfield2924324" runat="server">
											YYYY <INPUT id="txYy4" style="WIDTH: 56px; HEIGHT: 22px" size="4" name="textfield2924334" runat="server"><FONT face="宋体" color="#990000">*</FONT></TD>
									</TR> <!--
									<TR>
										<TD>&nbsp;</TD>
					...
					<tr>
						<td><asp:panel id="Panel3" runat="server" Width="392px" Visible="True">
								...
								<TABLE cellSpacing="0" cellPadding="0" width="397" border="0">
									...
									<TR>
										<TD><INPUT id="txReName1" style="WIDTH: 96px; HEIGHT: 22px" size="10" name="Text1" runat="server"><FONT face="宋体" color="#990000">*</FONT></TD>
										<TD><FONT face="宋体"><INPUT id="selReShip1" style="WIDTH: 96px; HEIGHT: 22px" size="10" name="Text1" runat="server"></FONT></TD>
										<TD><INPUT id="txReNum1" style="WIDTH: 96px; HEIGHT: 22px" size="10" name="Text4" runat="server"><FONT face="宋体" color="#990000">*</FONT></TD>
									</TR>
									<TR>
										<TD><INPUT id="txReName2" style="WIDTH: 96px; HEIGHT: 22px" size="10" name="Text2" runat="server"><FONT face="宋体" color="#990000">*</FONT></TD>
										<TD><INPUT id="selReShip2" style="WIDTH: 96px; HEIGHT: 22px" size="10" name="Text1" runat="server"></TD>
										<TD><INPUT id="txReNum2" style="WIDTH: 96px; HEIGHT: 22px" size="10" name="Text5" runat="server"><FONT face="宋体" color="#990000">*</FONT></TD>
									</TR>
									<TR>
										<TD><INPUT id="txReName3" style="WIDTH: 96px; HEIGHT: 22px" size="10" name="Text3" runat="server"></TD>
										<TD><FONT face="宋体"><INPUT id="selReShip3" style="WIDTH: 96px; HEIGHT: 22px" size="10" name="Text1" runat="server"></FONT></TD>
										<TD><INPUT id="txReNum3" style="WIDTH: 96px; HEIGHT: 22px" size="10" name="Text6" runat="server"></TD>
									</TR>
									<TR>
										<TD align="center" colSpan="4">
						...
						<td align="center"><asp:panel id="Panel4" runat="server" Width="392px" Visible="False" Height="208px">
								<TABLE cellSpacing="0" cellPadding="0" width="390" border="0">
									...
									<TR>
										...
										<TD colSpan="2">$<INPUT id="txLoan" style="WIDTH: 166px; HEIGHT: 22px" name="Text1" runat="server"><FONT face="宋体" color="#990000">*<INPUT id="Hidden1" style="WIDTH: 11px; HEIGHT: 22px" type="hidden" size="1" name="Hidden1"
													runat="server"> </FONT>
										</TD>
									</TR>
									<TR>
										...
										<TD colSpan="2"><FONT face="宋体" color="#990000">
												...
												<asp:Button id="Button1" runat="server" Text="Calculate"></asp:Button><INPUT id="txInstallment" style="WIDTH: 16px; HEIGHT: 22px" size="1" name="Text2" runat="server"
											...
											<TABLE>
												...
												<TR>
													<TD colSpan="3">Cash loans provided by Golden Bridge Enterprises (Aust) Pty Ltd<BR>
														...
														<TABLE borderColor="inactiveborder" cellSpacing="0" cellPadding="0" border="1">
															<TR>
																<TD>Loan Amount</TD>
																<TD></TD>
																<TD>Loan term</TD>
									...
									<TR>
										<TD colSpan="3"><TEXTAREA id="TEXTAREA1" name="TEXTAREA1" rows="3" readOnly cols="46" runat="server" value="By typing my name below I am applying for electronic cash loan and certify that this information is true and correct under penalty of perjury. I authorize Golden Bridge Cash Solution to verify any information submitted on this application."></TEXTAREA>
										</TD>
									</TR>
									<TR>
										<TD colSpan="3"></TD>
									...
									<TR>
										<TD align="center" colSpan="3"><INPUT id="Submit1" style="WIDTH: 110px; HEIGHT: 24px" type="submit" value="I agree, Submit"
												name="Submit" runat="server"><FONT face="宋体">&nbsp;&nbsp;&nbsp; </FONT><INPUT style="WIDTH: 52px; HEIGHT: 24px" type="submit" value="Reset" name="Submit2"></TD>
									</TR>
								</TABLE>
