...
namespace YingNet.WeiXing.DB.Data
{
	...
	public class EmployedDT
	{
		...
		private int m_OncePaymentInDays=0;
		/// <summary>
		/// 未来多少天内一次付款
		/// </summary>
		public int OncePaymentInDays
		{
			get{return this.m_OncePaymentInDays;}
			set{this.m_OncePaymentInDays= value;}
		}
		...
		private string m_ItemToPawn= string.Empty;
		/// <summary>
		/// 抵押的物品名称
		/// </summary>
		public string ItemToPawn
		{
			get{return this.m_ItemToPawn;}
			set{this.m_ItemToPawn= value;}
		}
		...
		{
			get{return this.m_ItemDescription;}
			set{this.m_ItemDescription= value;}
		}

		private string m_ItemCondition= string.Empty;
		/// <summary>
		/// 抵押的物品的成色
		/// </summary>
		public string ItemCondition
		{
			get{return this.m_ItemCondition;}
			set{this.m_ItemCondition= value;}
		}

		private string m_ItemPhoto= string.Empty;
		/// <summary>
		/// 抵押的物品的图片
		/// </summary>
		public string ItemPhoto
		{
			get{return this.m_ItemPhoto;}
			set{this.m_ItemPhoto=value;}
		}

		private string m_ItemPhotoNumber= string.Empty;
		/// <summary>
		/// 抵押的物品的图片序号
		/// </summary>
		public string ItemPhotoNumber
		{
			get{return this.m_ItemPhotoNumber;}
			set{this.m_ItemPhotoNumber=value;}
		}

		private int m_NeedGoldPack=0;
		/// <summary>
		/// 是否需要挂号信回执
		/// </summary>
		public int NeedGoldPack
		{
			get{return this.m_NeedGoldPack;}
			set{this.m_NeedGoldPack=value;}
		}
	}
}