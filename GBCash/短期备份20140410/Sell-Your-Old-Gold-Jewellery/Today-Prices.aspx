...
<body>
    ...
    <div id="main">
        <div>
          <div id="content" style="margin: 15px; float: left; padding: 5px 0 0 10px; width: 620px">
                <div id="links" style="padding: 20px 5px 5px 35px; font-family: Georgia, 'Times New Roman' , Times, serif">
                    <table >
                        <tr>
                ...
                <h2 style="color: #ff6600; padding: 20px">
                    Today's Price</h2>
                <table width="357" border="1">
                  <tr>
                    <td width="218" align="center"><span style="color: #000000; padding: 20px">9K Gold Item </span></td>
                    <td width="123" align="left">$17.95 per gram </td>
                  </tr>
                  <tr>
                    <td align="center">14K Golde Items </td>
                    <td align="left">$27.92 per gram</td>
                  </tr>
                  <tr>
                    <td align="center">18K Golde Items</td>
                    <td align="left">$35.90 per gram</td>
                  </tr>
                  <tr>
                    <td align="center">22K Golde Items</td>
                    <td align="left">$43.88 per gram</td>
                  </tr>
                  <tr>
                    <td align="center">24K Golde Items</td>
                    <td align="left">$47.87 per gram</td>
                  </tr>
                  <tr>
                    <td align="center">1oz Bars </td>
                    <td align="left">$1488.99 per bar </td>
                  </tr>
            </table>
                <table width="400" border="1">
                  <tr>
                    <td><span style="color: #000000; padding: 20px">*5% administration fee applies </span></td>
                  </tr>
                  <tr>
                    <td><span style="color: #000000; padding: 20px">Prices Updated: Thursday, 06 March 2014 </span></td>
                  </tr>
                  <tr>
                    <td>&nbsp;</td>
                  </tr>
                </table>
                <div style="padding-left: 20px; font-size: medium">
 <p><strong>How do we determine the worth of your gold?</strong></p>
 <p>Pricing your gold jewellery depends on several factors.</p>
                <p>1. The spot price of gold  and other precious metals and currency exchange rates.</p>
                <p>2. The purity your gold or other precious metals, the purer the gold the
                higher the price per gram.</p>
                <div style="padding: 1px 5px 5px 35px; font-family: Georgia, 'Times New Roman' , Times, serif">
                    <ul>
                        <li>24k is pure Gold at 99.99% </li>
                        <li>22k gold equals 91.6% purity (reflecting a combination of other metals)</li>
                        <li>18k gold equals 75% purity (reflecting a combination of other metals)</li>
                        <li>14k gold equals 58.5% purity (reflecting a combination of other metals)</li>
                        <li>9k gold equals 37.5% purity (reflecting a combination of other metals)</li>
                    </ul>
                </div>   
				 <p>3.The weight of your gold</p>
				 <p>The industry standard is to use grams. There are 31.1grams in a troy ounce of gold. We use super accurate scales that are calibrated each day for near perfect accuracy.</p>
            </div>
                  </ul>
                  <p>&nbsp;</p>
                  <p>If you have questions about how to sell your old gold jewllery, learn more about <a href="How-To-Sell.aspx">how to sell </a> , or contact <a href="../Contact-Us/Default.htm">Golden Bridge Finance Pty Ltd </a></p>
          </div>             
            </div>
            <div class="rite-pane">
                <div class="rite-hd">
