...
namespace YingNet.WeiXing.DB.Data
{
	...
	public class EmployedDT
	{
		...
		public string GrossIncomeChangeValue
		{
			get
			{
				return m_GrossIncomeChangeValue;
			}
			set
			{
				m_GrossIncomeChangeValue = value ;
			}
		}
		...
		{
			get{return this.m_IsGrossIncomeChange;}
			set{this.m_IsGrossIncomeChange= value;}
		}
		...
		public string PayOtherCreditValue
		{
			get
			{
				return m_PayOtherCreditValue;
			}
			set
			{
				m_PayOtherCreditValue = value ;
			}
		}
		...
		{
			get{return this.m_IsPayOtherCredit;}
			set{this.m_IsPayOtherCredit= value;}
		}
	}
