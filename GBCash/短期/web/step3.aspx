...
<table cellSpacing=0 cellPadding=0 width=396 border=0>
  <TBODY>
  <TR>
    <TD><asp:panel id=Panel5 
      runat="server" Width="344px">
      <TABLE style="WIDTH: 397px; HEIGHT: 56px" cellSpacing=0 cellPadding=0 
      width=397 border=0>
        <TR>
          <TD><STRONG>Employment Information</STRONG></TD></TR>
        <TR>
          <TD>
<asp:radiobuttonlist id=RadioButtonList1 runat="server" Width="352px" AutoPostBack="True" Visible="False">
											...
											</asp:radiobuttonlist></TD></TR></TABLE></asp:panel></TD></TR>
  <tr>
    <td><asp:panel id=Panel1 
      runat="server" Width="344px" Visible="True">
...
<asp:TextBox id=txhuiSid runat="server" Width="24px" Visible="False"></asp:TextBox></TD>
          <TD colSpan=3><INPUT id=txEmployer size=32 name=textfield2922 
            runat="server"> <FONT face=宋体 color=#990000>*</FONT></TD></TR>
        <TR>
          <TD style="WIDTH: 153px">Employer's Address:</TD>
          <TD colSpan=3><INPUT id=txAddress size=32 name=textfield2923 
            runat="server"> <FONT face=宋体 color=#990000>*</FONT></TD></TR>
        <TR>
          <TD style="WIDTH: 153px">Employer Phone Number:</TD>
          <TD colSpan=3><INPUT id=txPhone size=32 name=textfield2924 
            runat="server"> <FONT face=宋体 color=#990000>*</FONT></TD></TR>
        <TR>
          <TD style="WIDTH: 153px">Job Title:</TD>
          <TD colSpan=3><INPUT id=txJob size=32 name=textfield2924 
            runat="server"> <FONT face=宋体 color=#990000>*</FONT></TD></TR>
        <TR>
          <TD style="WIDTH: 153px">Time Employed: </TD>
          <TD colSpan=3><SELECT id=txYear name=select2 
        ...
        value=12>12</OPTION></SELECT>Months</TD></TR>
        <TR>
          <TD style="WIDTH: 153px">Take home pay after taxes: </TD>
          <TD colSpan=3>$<INPUT id=txIncome size=12 name=textfield29242 
            runat="server">.00<FONT face=宋体 color=#990000> <FONT face=宋体 
            color=#990000>*</FONT></FONT></TD></TR>
        <TR>
          <TD style="WIDTH: 153px">Per: </TD>
          <TD colSpan=3>
<asp:RadioButtonList id=RadioButtonList2 runat="server" Width="224px" RepeatDirection="Horizontal">
        ...
        <TR>
          ...
          <TD colSpan=3>DD <INPUT id=txDd1 size=2 name=textfield29243 
            runat="server"> MM <INPUT id=txMm1 size=2 name=textfield292432 
            runat="server"> YYYY <INPUT id=txYy1 size=4 name=textfield292433 
            runat="server"><FONT face=宋体 color=#990000>*</FONT></TD></TR>
        <TR>
          <TD style="WIDTH: 153px" colSpan=4>&nbsp;</TD></TR>
        <TR>
          <TD style="WIDTH: 153px" colSpan=4><STRONG>Financial 
            Obligations</STRONG></TD></TR>
        <TR>
          <TD colSpan=4>Are you in default in payment under other <A 
            class=title 
...
<asp:RadioButtonList id=rblHasOtherSamllCredit runat="server" RepeatDirection="Horizontal">
        ...
        <TR>
          <TD colSpan=4>How many other small amount credit contracts have you 
...
<asp:DropDownList id=ddlSmalCreditCount runat="server">
        ...
        <TR>
          <TD style="WIDTH: 153px" colSpan=4><STRONG>Expenses 
            Information</STRONG></TD></TR>
        <TR>
          <TD style="WIDTH: 153px">Your rent/mortgage payment:</TD>
          <TD colSpan=3>$<INPUT id=txtHousePaymentValue size=12 
...
<uc1:CircleDropDownList id=ddlHousePaymentCircle runat="server"></uc1:CircleDropDownList></TD></TR>
        <TR>
          ...
          <TD colSpan=3>$<INPUT id=txtOtherLenderValue size=12 
            name=txtOtherLenderValue runat="server">&nbsp; 
<uc1:CircleDropDownList id=ddlOtherLenderCircle runat="server"></uc1:CircleDropDownList></TD></TR></TABLE></asp:panel></TD>
  <tr>
    <td><asp:panel id=Panel2 
      runat="server" Width="380px" Visible="False">
      <TABLE id=Table2 cellSpacing=0 cellPadding=0 width=397 border=0>
        <TR>
          <TD style="WIDTH: 162px">&nbsp;</TD></TR>
        <TR>
          <TD style="WIDTH: 162px" width=162>Type of benefit:</TD>
          <TD colSpan=3><INPUT id=txType size=22 name=textfield2925 
            runat="server"><FONT face=宋体 color=#990000>*</FONT></TD></TR>
        <TR>
          <TD style="WIDTH: 162px">Centrelink Office:</TD>
          <TD colSpan=3><INPUT id=txOffice size=22 name=textfield29222 
            runat="server"><FONT face=宋体 color=#990000>*</FONT></TD></TR>
        <TR>
          <TD style="WIDTH: 162px">Contact Telephone Number:</TD>
          <TD colSpan=3><INPUT id=txContact size=22 name=textfield29232 
            runat="server"><FONT face=宋体 color=#990000>*</FONT></TD></TR>
        <TR>
          <TD style="WIDTH: 162px; HEIGHT: 22px">How long on this benefit: </TD>
          <TD style="HEIGHT: 22px" colSpan=3><SELECT id=txYear2 name=select2 
            runat="server"><OPTION value=0 selected>0</OPTION> <OPTION 
              value=1>1</OPTION> <OPTION value=2>2</OPTION> <OPTION 
              value=3>3</OPTION> <OPTION value=4>4</OPTION> <OPTION 
              value=5>5</OPTION> <OPTION value=6>6</OPTION> <OPTION 
        ...
        <TR>
          ...
          <TD colSpan=3><FONT face=宋体 color=#990000>$</FONT><INPUT 
            id=txBenefit size=15 name=textfield2924222 runat="server"><FONT 
            face=宋体 color=#990000>.00 <FONT face=宋体 
            color=#990000>*</FONT></FONT><FONT face=宋体 
        color=#990000></FONT></TD></TR>
        <TR>
          <TD style="WIDTH: 162px">Per: </TD>
          <TD colSpan=3>
<asp:RadioButtonList id=RadioButtonList3 runat="server" Width="224px" RepeatDirection="Horizontal">
        ...
        <TR>
          ...
          <TD colSpan=3>DD <INPUT id=txDd4 style="WIDTH: 40px; HEIGHT: 22px" 
  ...
  <tr>
    <td><asp:panel id=Panel3 
      runat="server" Width="392px" Visible="True">
      <TABLE id=Table3 cellSpacing=0 cellPadding=0 width=397 border=0>
        ...
        <TR>
          ...
          <TD width=108><INPUT id=txBranch size=10 name=textfield210 
            runat="server"><FONT face=宋体 color=#990000>*</FONT></TD></TR>
        <TR>
          <TD>Account Name:</TD>
          <TD colSpan=3><INPUT id=txAname name=textfield211 
            runat="server"><FONT face=宋体 color=#990000>*</FONT></TD></TR>
        <TR>
          <TD>BSB:</TD>
          <TD><INPUT id=txBsb size=10 name=textfield2112 runat="server"><FONT 
            face=宋体 color=#990000>*</FONT></TD>
          <TD>Account Number:</TD>
          <TD><INPUT id=txAnumber size=10 name=textfield21122 
            runat="server"><FONT face=宋体 color=#990000>*</FONT></TD></TR>
        <TR>
          <TD colSpan=2>Confirm Account Numer:</TD>
          <TD colSpan=2><INPUT id=txCAnumber name=textfield2113 
            runat="server"><FONT face=宋体 color=#990000>*</FONT></TD></TR>
        <TR>
...
<asp:RadioButtonList id=RadioButtonList4 runat="server" Width="312px" RepeatDirection="Horizontal">
      ...
      <TABLE cellSpacing=0 cellPadding=0 width=397 border=0><!--
        ...
        <TR>
          <TD align=center colSpan=4>
<asp:LinkButton id=Linkbutton3 runat="server">Next >>></asp:LinkButton></TD></TR></TABLE></asp:panel></TD></TR>
  <tr>
    <td align=center><asp:panel id=Panel4 
       runat="server" Width="392px" Visible="False" 
      Height="208px">
      <TABLE cellSpacing=0 cellPadding=0 width=390 border=0>
        <TR>
          <TD width="100%"><STRONG>Loan Requirements</STRONG><BR></TD></TR>
        <TR>
          <TD colSpan=3>What is the primary purpose of the loan: </TD></TR>
        <TR>
          <TD style="WIDTH: 143px" colSpan=3>
<asp:TextBox id=txtLoanPurpose runat="server" Width="392px" Height="22px"></asp:TextBox></TD></TR>
        <TR>
          <TD style="WIDTH: 143px" width=143 colSpan=3>Loan Requested:</TD>
          <TD colSpan=2></TD></TR>
        <TR>
          <TD style="WIDTH: 143px" colSpan=3>$<INPUT id=txLoan 
            style="WIDTH: 166px; HEIGHT: 22px" name=Text1 runat="server"><FONT 
            face=宋体 color=#990000>*<INPUT id=Hidden1 
            style="WIDTH: 11px; HEIGHT: 22px" type=hidden size=1 name=Hidden1 
            runat="server"> 
<asp:Button id=Button1 runat="server" Text="Calculate"></asp:Button></FONT></TD></TR>
        <TR style="DISPLAY: none">
          <TD style="WIDTH: 143px; HEIGHT: 2px" width=143>Loan Repayment:</TD>
          <TD style="HEIGHT: 2px" colSpan=2><FONT face=宋体 color=#990000>
<asp:DropDownList id=DropDownList1 runat="server">
            ...
            visible="false"></FONT></TD></TR>
        <TR>
          <TD colSpan=3>Note: Each installment dues on your payday . Please 
            make sure your repayment funds are available in your account for 
            deduction on each installment due date.</TD></TR>
        <TR>
          <TD colSpan=3></TD></TR>
        <TR>
          <TD style="WIDTH: 160px" width=143 colSpan=3><BR><STRONG>Repayment 
            Schedule</STRONG></TD></TR>
        <TR>
          <TD colSpan=3>
            <TABLE>
              <TR>
                ...
                <TD width=120>Repayment due</TD></TR><%
              ...
              <TR>
                ...
                <TD><FONT face=宋体><%=payAmountPerTime4Schedule.ToString("0.00")%></FONT></TD></TR><%}%></TABLE></TD></TR>
          ...
          <TD colSpan=3>
            <TABLE><!--
              ...
              <TR>
                <TD colSpan=3>&nbsp;</TD></TR>
              <TR>
                <TD style="WIDTH: 160px" width=143 
                  colSpan=3><BR><STRONG>Comparison Rate Schedule</STRONG></TD></TR>
              <TR>
                <TD colSpan=3>Cash loans provided by Golden Bridge Enterprises 
                  (Aust) Pty Ltd<BR>Date of issue: 01/10/05<BR>
                  ...
                  border=1>
                    ...
                    <TR>
                      ...
                      <TD>8 weeks</TD>
                      <TD>486.89%</TD>
                      <TD>486.89%</TD></TR></TABLE></TD></TR>
              <TR>
                <TD colSpan=3><STRONG>WARNING</STRONG>: This Comparison Rate 
                  ...
                  Comparison Rate but may influence the cost of the 
              loan.</TD></TR></TABLE></TD></TR>
        <TR>
          <TD style="WIDTH: 143px" align=center>&nbsp;</TD></TR>
        <TR>
          <TD colSpan=3>
            <DIV id=divAgreement 
            style="BORDER-RIGHT: black 1px solid; BORDER-TOP: black 1px solid; OVERFLOW: auto; BORDER-LEFT: black 1px solid; BORDER-BOTTOM: black 1px solid; HEIGHT: 150px">&nbsp;&nbsp;By 
            ...
            fees and penalties are recovered.</DIV></TD></TR>
        <TR>
          <TD colSpan=3></TD></TR>
        <TR>
          <TD colSpan=3>To Sign,please type your FULL name here: 
<asp:TextBox id=txFullname runat="server" Width="145px"></asp:TextBox></TD></TR>
        <TR>
          <TD style="WIDTH: 143px">&nbsp;</TD></TR>
        <TR>
          <TD align=center colSpan=3><INPUT id=Submit1 style="WIDTH: 110px; HEIGHT: 24px" type=submit value="I agree, Submit" name=Submit runat="server"><FONT 
            face=宋体>&nbsp;&nbsp;&nbsp; </FONT><INPUT style="WIDTH: 52px; HEIGHT: 24px" type=submit value=Reset name=Submit2></TD></TR></TABLE></asp:panel></TD></TR></TBODY></TABLE></FORM>
<div class="modal modalFix" id=EditDIV></DIV>
