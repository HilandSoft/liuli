<%@ Page language="c#" Codebehind="ProductAdd.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.ProductAdd" %>
<HTML>
	<HEAD>
		<title>
			<%=WebAppTitle%>
										...
										<tr>
											<td>
												<table width="100%" height="100%">
													<tr>
														<td height="30" align="center" style='FONT-SIZE:16px'>添 加 产 品</td>
													</tr>
													<tr>
													...
													<tr>
														<td height="200" width="400" valign="top" align="center"><table>
																<tr>
																	...
																	<td><asp:TextBox id="TextBox1" runat="server" Width="184px" CssClass="iinput"></asp:TextBox>
																		<asp:CheckBox id="CheckBox1" runat="server" Text="推荐" Font-Size="12px"></asp:CheckBox></td>
																</tr>
																<tr>
																	<td align="right">图片:</td>
																	<td><INPUT id="File1" type="file" name="File1" runat="server" class="iinput" style="WIDTH: 240px; HEIGHT: 19px"
																			size="20"></td>
																</tr>
																<tr>
