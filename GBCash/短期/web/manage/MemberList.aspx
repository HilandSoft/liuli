<%@ Page language="c#" Codebehind="MemberList.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.MemberList" %>
							...
							<tr>
								<td align="center" valign="top">
									<asp:DropDownList id="DropDownList1" runat="server">
										...
										<asp:ListItem Value="10">Birthday</asp:ListItem>
									...
									<asp:TextBox id="txCondition" runat="server" Width="7px" Visible="False"></asp:TextBox>&nbsp;
				...
				<tr>
					<td vAlign="top"><cc1:datagridtable id="DataGridTable1" runat="server" IsAllowPaging="True" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="DBirth" HeaderText="DateBirth" DataFormatString="{0:dd-MM-yyyy}"></asp:BoundColumn>
								...
								<asp:BoundColumn DataField="Regtime" HeaderText="Regtime"></asp:BoundColumn>
								<asp:BoundColumn DataField="IsValid" HeaderText="Status"></asp:BoundColumn>
								<asp:BoundColumn DataField="Param3" HeaderText="Score"></asp:BoundColumn>
								<asp:HyperLinkColumn Text="Loan Info" DataNavigateUrlField="id" DataNavigateUrlFormatString="loandetail.aspx?id={0}"></asp:HyperLinkColumn>
								<asp:HyperLinkColumn Text="Detail" DataNavigateUrlField="id" DataNavigateUrlFormatString="MemberDetail.aspx?id={0}"></asp:HyperLinkColumn>
								<asp:BoundColumn HeaderText="Notes" DataField="Note"></asp:BoundColumn>
								<asp:BoundColumn HeaderText="FollowUpHistory" DataField="FollowUpHistory"></asp:BoundColumn>
								<asp:HyperLinkColumn Text="Personal Info History" DataNavigateUrlField="Username" DataNavigateUrlFormatString="MemberHistory.aspx?id={0}"></asp:HyperLinkColumn>
								<asp:HyperLinkColumn Text="Employed Info History" DataNavigateUrlField="id" DataNavigateUrlFormatString="InforHistory.aspx?id={0}"></asp:HyperLinkColumn>
								<asp:HyperLinkColumn Text="Delete" DataNavigateUrlField="id" DataNavigateUrlFormatString="MemberDel.aspx?id={0}"></asp:HyperLinkColumn>
								<asp:HyperLinkColumn Text="ToProcessCenter" DataNavigateUrlField="id" DataNavigateUrlFormatString="SendToProcessCenter.aspx?id={0}"></asp:HyperLinkColumn>
								<asp:HyperLinkColumn Text="ToFollowupCenter" DataNavigateUrlField="id" DataNavigateUrlFormatString="SendToFollowupCenter.aspx?id={0}"></asp:HyperLinkColumn>
							</Columns>
						</cc1:datagridtable>
