			...
			if (!this.Page.IsPostBack)
            {
                ...
                if (table2.Rows.Count > 0)
                {
					...
					*/
					...
					if(lastRow["IsGrossIncomeChange"]!=null)
					{
						try
						{
							if(int.Parse( lastRow["IsGrossIncomeChange"].ToString())==1)
							{
					...
					if(lastRow["IsPayOtherCredit"]!=null)
					{
						try
						{
							if(int.Parse( lastRow["IsPayOtherCredit"].ToString())==1)
							{
					...
					if(lastRow["GrossIncomeChangeValue"]!=null)
					{
						this.GrossIncomeChangeValue= lastRow["GrossIncomeChangeValue"].ToString();
					}

					if(lastRow["PayOtherCreditValue"]!=null)
					{
						this.PayOtherCreditValue= lastRow["PayOtherCreditValue"].ToString();
					}
					//----------------------------------------------------------------------
