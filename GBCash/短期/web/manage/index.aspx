																						...
																						<TR align="center" height="40">
																							<TD colSpan="2"><div align="center">
																									<asp:DropDownList CssClass="dropDownList" Runat="server" ID="ddlManagerChoose">
																										<asp:ListItem Value="ShortMember" Selected="True">Short Member Management</asp:ListItem>
																										<asp:ListItem Value="LongMember">Long Member Management</asp:ListItem>
																										<asp:ListItem Value="ShortProcessCenter">Short ProcessCenter</asp:ListItem>
																										<asp:ListItem Value="LongProcessCenter">Long ProcessCenter</asp:ListItem>
																										<asp:ListItem Value="ShortFollowupCenter">Short FollowupCenter</asp:ListItem>
																										<asp:ListItem Value="LongFollowupCenter">Long FollowupCenter</asp:ListItem>
