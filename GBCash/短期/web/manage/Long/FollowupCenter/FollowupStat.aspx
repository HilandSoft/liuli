...
<%@ Page language="c#" Codebehind="FollowupStat.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.Long.FollowupCenter.FollowupStat" %>
<%@ Register TagPrefix="cc1" Namespace="YingNet.Common" Assembly="YingNet.Common" %>
			...
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" bgColor="#fefefe" border="0">
						...
						<table cellSpacing="0" cellPadding="0" width="99%" border="0">
							<tr>
								<td vAlign="top" align="center">
									<asp:dropdownlist id="ddlQuery" runat="server"></asp:dropdownlist>BeginDate(dd/mm/yyyy):
									<asp:textbox id="tbxBeginDateD" runat="server" Width="22px"></asp:textbox>/<asp:textbox id="tbxBeginDateM" runat="server" Width="22px"></asp:textbox>/<asp:textbox id="tbxBeginDateY" runat="server" Width="38px"></asp:textbox>EndDate(dd/mm/yyyy):<asp:textbox id="tbxEndDateD" runat="server" Width="22px"></asp:textbox>/<asp:textbox id="tbxEndDateM" runat="server" Width="22px"></asp:textbox>/<asp:textbox id="tbxEndDateY" runat="server" Width="38px"></asp:textbox>
									<asp:button id="btnQuery" runat="server" Text="Query"></asp:button>&nbsp;<A onclick="window.print();" href="#">Print</A><asp:label id="Label1" runat="server"></asp:label><asp:textbox id="txCondition" runat="server" Visible="False" Width="7px"></asp:textbox>&nbsp;
								</td>
							</tr>
						</table>
					</td>
				...
				<tr>
					<td vAlign="top"><cc1:datagridtable id="DataGridTable1" runat="server" Width="100%" BorderStyle="None" BorderWidth="1px"
							...
							<Columns>
								<asp:BoundColumn Visible="False" DataField="followupID"></asp:BoundColumn>
								...
								<asp:TemplateColumn HeaderText="PreStatus">
									<HeaderStyle></HeaderStyle>
									<HeaderTemplate>
										PreStatus
									</HeaderTemplate>
									<ItemTemplate>
										<asp:Literal ID="LitPreStatus" Runat="server"></asp:Literal>
									</ItemTemplate>
								</asp:TemplateColumn>
