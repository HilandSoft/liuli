...
{
	/// <summary>
	/// LMemberLoadFollowUpHistory 的摘要说明。
	/// </summary>
	public class LMemberLoadFollowUpHistory : System.Web.UI.Page
	{
		...
		private void GetInfo()
		{
			if(this.memberID>0)
			{
				...
				if(dt!=null)
				{
					this.txtFollowUpDisplay.Text= dt.Other2;
				}
			}
		}
		...
		private void EditButton_Click(object sender, System.EventArgs e)
		{
			if(this.memberID>0)
			{
				...
				if(dt!=null)
				{
					dt.Other2= this.txtFollowUpDisplay.Text;
					bn.Edit(dt);
				}
