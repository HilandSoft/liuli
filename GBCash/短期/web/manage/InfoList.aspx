<%@ Page language="c#" Codebehind="InfoList.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.InfoList" %>
			...
			<table id="Table1" style="BORDER-RIGHT: #336699 1px solid; BORDER-TOP: #336699 1px solid; BORDER-LEFT: #336699 1px solid; BORDER-BOTTOM: #336699 1px solid"
				...
				<tr>
					<td vAlign="middle" background="images/left_top_title_bk.gif" height="25" class='aaa'>
						...
						<IMG language="javascript" class="imgst" id="image" onmouseover="onmouseOutImg()" title="显示或关闭左侧导航条"
					...
					<td background="images/left_top_title_bk.gif" height="25" align="right" class='aaa'>
						信息管理
					</td>
				...
				<tr>
					<td colSpan="3">
						<table id="Table2" style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; FONT-SIZE: 12px; BORDER-LEFT: 0px; BORDER-BOTTOM: 0px; BORDER-COLLAPSE: collapse"
							...
							<tr>
								<td height="26"><nobr>&nbsp;&nbsp;
								<INPUT type="button" value="添加类型" class="toolbar" id="AddProductType" onclick="window.location='infotypeadd.aspx';"> <INPUT class="toolbar" id="EditProductType" type="button" value="修改类型" onclick="window.location='infotypeedit.aspx';"><INPUT class="toolbar" id="delProductType" type="button" value="删除类型" onclick="window.location='infotypedel.aspx';"><INPUT class="toolbar" id="AddProduct" type="button" value="添加信息"
											name="Button3" onclick="window.location='infoadd.aspx';">
								...
								<td>
									<div id="Div1" style="OVERFLOW-Y: auto; SCROLLBAR-FACE-COLOR: #dee3e7; SCROLLBAR-HIGHLIGHT-COLOR: #ffffff; WIDTH: 100%; SCROLLBAR-SHADOW-COLOR: #dee3e7; SCROLLBAR-3DLIGHT-COLOR: #d1d7dc; SCROLLBAR-ARROW-COLOR: #006699; SCROLLBAR-TRACK-COLOR: #efefef; SCROLLBAR-DARKSHADOW-COLOR: #98aab1; HEIGHT: 100%">
										<cc1:DataGridTable id="DataGridTable1" runat="server" PageSize="12" Width="100%" CellPadding="4" BorderColor="#3366CC"
											...
											<Columns>
												<asp:BoundColumn DataField="InfoID" HeaderText="序号">
													<HeaderStyle Width="40px"></HeaderStyle>
													<FooterStyle Wrap="False"></FooterStyle>
												</asp:BoundColumn>
												<asp:HyperLinkColumn DataNavigateUrlField="InfoID" DataNavigateUrlFormatString="infoedit.aspx?InfoID={0:d}"
													DataTextField="InfoTitle" HeaderText="标题"></asp:HyperLinkColumn>
												<asp:HyperLinkColumn Text="修改" DataNavigateUrlField="InfoID" DataNavigateUrlFormatString="infoedit.aspx?InfoID={0:d}"
													HeaderText="修改">
													<HeaderStyle Width="60px"></HeaderStyle>
												</asp:HyperLinkColumn>
												<asp:HyperLinkColumn Text="删除" DataNavigateUrlField="InfoID" DataNavigateUrlFormatString="infoedel.aspx?infoID={0:d}"
													HeaderText="删除">
													<HeaderStyle Width="60px"></HeaderStyle>
												</asp:HyperLinkColumn>
											</Columns>
