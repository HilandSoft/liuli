    ...
    public class MainTop : ManageBasePage
    {
    	...
    	private void ShowMenu()
    	{
			...
			if(this.SystemUserID!=0)
			{
				...
				sb.AppendFormat(menuItemString, "d0", "<a href='javascript:jumps(\"AdminList.aspx\")'>ManagerList </a>");
				sb.AppendFormat(menuItemString, "d1", "<a href='javascript:jumps(\"../SystemInfo.aspx\")'>ShortParamSetting </a>");
				sb.AppendFormat(menuItemString, "d2", "<a href='javascript:jumps(\"../long/ParamsSet.aspx\")'>LongParamSetting </a>");
