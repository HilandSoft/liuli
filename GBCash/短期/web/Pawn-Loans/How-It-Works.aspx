<%@ Page language="c#" autoeventwireup="false" inherits="YingNet.WeiXing.WebApp.Pawn_Loans.How_It_Works" enableviewstatemac="false" CodeBehind="How-It-Works.aspx.cs" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		...
		<script type="text/javascript" src="../swfobjectN/swfobject.js"></script>
		...
		<form id="form1" runat="server">
			...
			<div id="main">
				...
				<div id="content" style="margin-left: 5px;">
					<h1>
						Get Cash Now! Pawn your gold, silver, platinum or all 9-24 karat jewellery.
					</h1>
					<p>
						When BANKS SAY NO! WE SAY YES!</p>
					<p>&nbsp;
					</p>
					<p>
						Everyone has at one time or another come up a little short of cash to pay an 
						unexpected bill, fill the car up with gas, or just to have a little extra 
						spending money.
						<br>
						<br>
						Pawn loans are a quick and easy way to borrow money without a credit check or 
						hassle. Loans are based on the value of your collateral, not your credit rating 
						or pay schedule.
						<br>
						<br>
						With a pawn loan, you can borrow $50 to $20,000 or even more!
						<br>
						<br>
						There is never a credit check, there are no long forms to fill out and we give 
						you cash within minutes. You can have as many pawn loans outstanding as you 
						want and we don’t report to credit agencies.
					</p>
					<p>&nbsp;
					</p>
					<p>
						<strong><strong>You can visit one of our </strong><strong>stores or pawn your items 
								online from the comfort and privacy of your home</strong>.</strong> Use 
						our online pawn form and get money fast. No credit checks, just high quality 
						collateral loans. You will simply fill out the form with the item’s 
						information, we send you a quote, you send us the item and we inspect it and 
						then send you the money.
					</p>
					<p>&nbsp;
					</p>
					<p>
						<strong>What do we loan on</strong></p>
					<p>&nbsp;
					</p>
					<ul>
						<li>
					...
					<p>
						Simply bring us an item of value, along with a valid photo ID and we’ll get you 
						money in minutes after your loan is approved.
					</p>
					<p>&nbsp;
					</p>
					<p class="style2">
					...
					<p>
						1. Your property is evaluated to determine the loan value of the item. Based on 
						the condition and quality of the item, a loan value is set.
					</p>
					<p>&nbsp;
					</p>
					<p>
						2. You will then be informed of the conditions of the loan and will be given a 
						contract to sign. You will then receive the cash for your loan!
					</p>
					<p>&nbsp;
					</p>
					<p>
						3. Your collateral will be held safely and securely at the store in storage 
						during the term of the loan.
					</p>
					<p>&nbsp;
					</p>
					<p>
						<strong>Loan Extensions </strong>
					</p>
					<p>&nbsp;
					</p>
					<p>
						If you cannot pay back your loan in full, including any applicable grace 
						period, we offer extensions/renewals to give you extra time. You may also 
						choose to surrender your collateral as payment in full.
					</p>
					<p>&nbsp;
					</p>
					<p>
						With an extension, you will be required to pay a portion of the interest owed , 
						then you may extend the length of your loan for as many days as you require.
					</p>
					<p>&nbsp;</p>
					<p align="center"><span class="style1"><a href="Pawn-Online-Now.aspx">Click here to Pawn 
								Online Now </a>
						</span>
					</p>
					<p>
						<br>
						Golden Bridge Finance Pty Ltd (ABN: 72 134 151 830)</p>
					<p>Business Licensing Rgistration No. SHD-0014370
					</p>
				</div>
			</div>
			<!--end main-->
			...
			<div id="footer">
				&copy; Copyright Golden Bridge Finance Pty Ltd 2012</div>
