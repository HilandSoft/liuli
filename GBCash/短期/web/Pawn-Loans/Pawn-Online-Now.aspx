<%@ page language="C#" autoeventwireup="true" inherits="Pawn_Loans_Pawn_Online_Now, App_Web_fwyr0g42" enableviewstatemac="false" %>
...
<head runat="server">
    ...
    <style type="text/css">
        ...
        ul.btns a
        {
            background: url("../imagesN/greenbtn.gif") no-repeat scroll 0 0 transparent;
            color: #FFFFFF;
            display: block;
            font-family: Georgia, "Times New Roman" ,Times,serif;
            font-size: 15px;
                ...
                <ul class="children">
                    ...
                    <li><a href="#">Pawn Loans</a>
                        <ul class="nestedchildren">
                            ...
                            <li><a href="http://gbcash.com.au/Pawn-Loans/Acceptable-Collateral.aspx">Acceptable
                                Collateral</a></li>
        ...
        <div id="content" style="margin-left: 5px; top: 0px; left: 0px;">
            ...
            <table class="form">
                ...
                <tr>
                    ...
                    <td class="rightrow">
                        <asp:DropDownList ID="drpStates" runat="server" Width="100px">
                ...
                <tr>
                    ...
                    <td class="rightrow">
                        <asp:TextBox ID="TextBox7" runat="server" Width="250" TextMode="MultiLine" Rows="5"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="leftrow">
                ...
                <tr>
                    ...
                    <td class="rightrow">
                        <asp:DropDownList ID="DropDownList3" runat="server" Width="100px">
                            ...
                            <asp:ListItem>Normal wear and tear</asp:ListItem>
