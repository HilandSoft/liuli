							...
							<tr>
								<td height="25" align="center">
									<asp:checkboxlist id="CheckBoxList1" runat="server" Width="500px">
										...
										<asp:ListItem Value="5">Have you read and understood Golden Bridge Cash Solution's <a href="Root/Attachment/information2.htm" target="_blank">
												Information Statement</a> ,<a href="Root/Attachment/Form3A.doc" target="_blank">Form3A</a>, <a target="_blank" href="Root/Attachment/Credit-Guide.doc">Credit 
												Guide</a>?</asp:ListItem>
									</asp:checkboxlist></td>
							</tr>
							<tr>
								<td height="10">&nbsp;</td>
