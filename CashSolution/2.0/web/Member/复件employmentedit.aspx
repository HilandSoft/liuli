...
<HTML>
	...
	<body LEFTMARGIN="0" TOPMARGIN="0" MARGINWIDTH="0" MARGINHEIGHT="0">
		<TABLE height="850" cellSpacing="0" cellPadding="0" width="687" border="0" ms_2d_layout="TRUE">
			<TR vAlign="top">
				<TD width="687" height="850">
					<form id="Form1" method="post" runat="server">
						<TABLE height="685" cellSpacing="0" cellPadding="0" width="848" border="0" ms_2d_layout="TRUE">
							<TR vAlign="top">
								<TD width="97" height="685"></TD>
								<TD width="751">
									<table width="750" border="0" align="center" cellpadding="0" cellspacing="0" height="684">
										<tr>
										...
										<tr>
											...
											<td width="556" align="center">
												<table cellSpacing="0" cellPadding="0" width="500" border="0">
													<tr>
														<td>
															<TABLE height="100%" cellSpacing="0" cellPadding="0" width="397" border="0">
																...
																<TR>
																	<TD width="168" height="20"><asp:radiobuttonlist id="RadioButtonList1" runat="server" AutoPostBack="True" Width="352px">
													...
													<tr>
														<td><asp:panel id="Panel1" runat="server" Width="344px" Visible="True" Height="232px">
																<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="397" border="0">
																	...
																	<TR>
																		<TD>Employer:</TD>
																		<TD colSpan="3"><INPUT id="txEmployer" type="text" size="20" name="textfield2922" runat="server"><FONT face="???" color="#990000">*<INPUT id="txMm1" type="text" size="1" value="1" name="textfield292432" runat="server"
																					visible="false"><INPUT id="txDd1" type="text" size="1" value="1" name="textfield29243" runat="server" visible="false"><INPUT id="txYy1" type="text" size="1" value="1" name="textfield292433" runat="server"
													...
													<tr>
														<td height="202"><asp:panel id="Panel2" runat="server" Width="380px" Visible="False" Height="192px">
																<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="397" border="0">
																	<TR>
																		<TD width="127">Type of benefit:</TD>
																		<TD colSpan="3"><INPUT id="txType" type="text" size="15" name="textfield2925" runat="server"><FONT face="???" color="#990000">*<INPUT id="txDd4" type="text" size="1" value="1" name="textfield292436" runat="server"
																					visible="false"><INPUT id="txYy4" type="text" size="1" value="1" name="textfield2924334" runat="server"
																					visible="false"><INPUT id="txMm4" type="text" size="1" value="1" name="textfield2924324" runat="server"
																					visible="false"></FONT></TD>
																	</TR>
																	<TR>
