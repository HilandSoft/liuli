				...
				<tr>
					...
					<td valign="top">
						<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								<TD colSpan="2">
								  <p>Please note it will take approximately 5 minutes to complete your application. Please enter all required information, indicated with an asterisk. Before submitting your application, you will be able to view and amend the 
										information you have entered.</p>
								  </TD>
							</TR>
							<TR>
							  <TD colSpan="2">&nbsp;</TD>
