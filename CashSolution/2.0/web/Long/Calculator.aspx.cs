                ...
                if (table.Rows.Count > 0)
                {
                        ...
                        if (str != null)
                        {
                            ...
                            else
                            {
                                ...
                                if (span.Days < 15)
                                {
                                    ...
                                    time4 = date.AddDays((double) (7 * addMonths));
                                }
                                else
                                {
                                    nextMonth = date;
                                    time4 = date.AddDays((double) (7 * (addMonths - 1)));
                                }
                            }
                        }
                        goto Label_05A2;
                    Label_03F6:
                        ...
                        if (span.Days < 15)
                        {
                            ...
                            time4 = date.AddDays((double) (14 * addMonths));
                        }
                        else
                        {
                            nextMonth = date;
                            time4 = date.AddDays((double) (14 * (addMonths - 1)));
                        }
                        goto Label_05A2;
                    Label_047E:
                        if (span.Days > 0x10)
                        ...
                        if (span.Days < 15)
                        {
                            ...
                            time4 = LongTermSchedule.GetNextBiMonth(nextDate, nextMonth, num5);
                        }
                        else
                        {
                            nextMonth = date;
                    ...
                    Label_052A:
                        ...
                        if (span.Days < 15)
                        {
                            ...
                            time4 = LongTermSchedule.GetNextMonth(date, addMonths);
                        }
                        else
                        {
                            nextMonth = date;
                            time4 = LongTermSchedule.GetNextMonth(date, addMonths - 1);
                        }
                    Label_05A2:
                        num *= 0.01;
