  ...
  <HEAD>
	...
	<body leftMargin="0" topMargin="0" MARGINHEIGHT="0" MARGINWIDTH="0">
		<form id="Form1" method="post" runat="server">
          ...
          <TD >$<INPUT id=txtHousePaymentValue type=text size=12 
...
<uc1:CircleDropDownList id=ddlHousePaymentCircle runat="server"></uc1:CircleDropDownList></TD></TR>
        <TR>
          ...
          <TD >$<INPUT id=txtOtherLenderValue type=text size=12 
...
<uc1:CircleDropDownList id=ddlOtherLenderCircle runat="server"></uc1:CircleDropDownList></TD></TR>
      ...
      <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
        <TR>
          ...
          <TD>
<asp:TextBox id=txRepayA runat="server" Width="150"></asp:TextBox></TD></TR>
        <TR>
          <TD height=30>Repayment Frequency:</TD>
          <TD>
<asp:TextBox id=txRepayF runat="server" Width="150"></asp:TextBox></TD></TR>
        <TR>
          <TD height=30>Number of Instalment:</TD>
          <TD>
<asp:TextBox id=txNumber runat="server" Width="150"></asp:TextBox></TD></TR>
        <TR>
          <TD height=30>Payment Start:</TD>
          <TD>
<asp:TextBox id=txStart runat="server" Width="150"></asp:TextBox></TD></TR>
        <TR>
          <TD height=30>Payment End:</TD>
          <TD>
<asp:TextBox id=txEnd runat="server" Width="150"></asp:TextBox></TD></TR></TABLE>
							</asp:Panel></FONT>
					</td>
				</tr>
				<tr>
