<%@ Page language="c#" Codebehind="MainTop.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.MainTop" %>
<HTML>
	<HEAD>
		<title>
			<%=WebAppTitle%>
		...
		<style> .wnd_label_normal { CURSOR: hand; font-weight: bold; font-size: 14px; color:#0066cc}
	.wnd_label_hover { CURSOR: hand; font-weight: bold; font-size: 14px; color:#ffffff}
	.wnd_label_active { CURSOR: hand; font-weight: bold; font-size: 14px; color:#336699 }
	nobr{CURSOR: hand}
		</style>
