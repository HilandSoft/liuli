<%@ Page language="c#" Codebehind="UserAdd.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.UserAdd" %>
<HTML>
	<HEAD>
				...
				<tr>
					<td colSpan="2">
						<table id="Table2" style="BORDER-RIGHT: 0px; BORDER-TOP: 0px; FONT-SIZE: 12px; BORDER-LEFT: 0px; BORDER-BOTTOM: 0px; BORDER-COLLAPSE: collapse"
							...
							border="1">
							<tr>
								<td height="26"><nobr>&nbsp;&nbsp;&nbsp;添加用户：</nobr></td>
							</tr>
							<tr>
								<td vAlign="top">
									<table align="center" width="80%">
										<tr height="32">
											...
											<td><asp:TextBox id="Tex_User" runat="server" s_msg="用户名不能为空!" Width="82px"></asp:TextBox>
											</td>
											<td><asp:Label id="lab_password" runat="server">密码</asp:Label>
											</td>
											<td><asp:TextBox id="Tex_Password" runat="server" s_msg="密码不能为空!" Width="89px"></asp:TextBox>
											</td>
											<td><asp:Label id="Lab_name" runat="server">姓名</asp:Label>
											</td>
											<td><asp:TextBox id="Tex_Name" runat="server" s_msg="姓名不能为空!"></asp:TextBox>
											</td>
										</tr>
										<tr>
											<td colspan="8" height="32">权限：&nbsp;&nbsp;&nbsp;&nbsp;</td>
										</tr>
										<tr>
										...
										<tr>
											<td colspan="8" align="center">
												<asp:Button id="Button2" runat="server" Text=" 保 存 " CssClass="toolbar"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;
												<INPUT class="toolbar" id="Button3" type="button" value=" 重 写 " name="Button1" runat="server"></td>
										</tr>
									</table>
								</td>
							</tr>
