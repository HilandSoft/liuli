...
{
	/// <summary>
	/// MemberLoadNotes 的摘要说明。
	/// </summary>
	public class MemberLoadNotes : System.Web.UI.Page
	{
		...
		private void GetInfo()
		{
			if(this.memberID>0)
			{
				...
				if(dt!=null)
				{
					this.txtNoteDisplay.Text= dt.NoteContent;
					//this.ViewState["dt.NoteID"]= dt.NoteID;
				}
			}
		}
		...
		private void EditButton_Click(object sender, System.EventArgs e)
		{
			if(this.memberID>0)
			{
				...
				if(dt!=null)
				{
					dt.NoteContent= this.txtNoteDisplay.Text;
					bn.Edit(dt);
				}
				else
				{
