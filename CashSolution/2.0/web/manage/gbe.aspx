<%@ Page language="c#" Codebehind="gbe.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.gbe" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>gbe</title>
		<LINK href="../css/css.css" type="text/css" rel="stylesheet">
			<style type="text/css"> .unnamed1 { FONT-SIZE: 12px; LINE-HEIGHT: 18px; TEXT-DECORATION: none }
						...
						<table cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<tr>
								<td>
									<table cellSpacing="0" cellPadding="0" width="645" border="0" style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #000000 1px solid; BORDER-LEFT: #000000 1px solid; BORDER-BOTTOM: #000000 1px solid">
										<tr>
											<td width="50%">Financial Institution : <input id="txBank" style="BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none"
