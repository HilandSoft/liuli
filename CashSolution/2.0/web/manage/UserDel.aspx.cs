	...
	public class UserDel : ManageBasePage
	{
		...
		private void returnmain_ServerClick(object sender, EventArgs e)
		{
			if (this.TextBox1.Text != null)
			{
				...
				{
					base.Response.Write("<script>alert('É¾³ý³É¹¦!');window.location =\"UserManage.Aspx\"; </script>");
				}
				else
				{
					base.Response.Write("<script>alert('É¾³ýÊ§°Ü!'); window.location =\"UserManage.Aspx\";</script>");
				}
			}
			else
			{
				this.LabMsg.Text = "²Ù×÷´íÎó£¡";
			}
		}
	}
}
