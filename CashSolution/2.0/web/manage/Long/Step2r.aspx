					...
					<td valign="top">
						<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
							...
							<TR>
								...
								<TD width="17%"><INPUT id="txStreet" type="text" style="WIDTH:120px" name="textfield22322522" runat="server">
							...
							<TR>
								...
								<TD><cc2:AustralianStateDropDownList id="AustralianStateDropDownList" runat="server"></cc2:AustralianStateDropDownList>
									<FONT color="#ff0000">*</FONT></TD>
								<TD>Postcode :</TD>
														...
														<TR>
															<TD>
																<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
																	...
																	<TR>
																		<TD height="30">State :</TD>
																		<TD><cc2:AustralianStateDropDownList id="AustralianStateDropDownList1" runat="server"></cc2:AustralianStateDropDownList>
																			<FONT color="#ff0000">*</FONT></TD>
																		<TD>Postcode :</TD>
