<%@ Page language="c#" Codebehind="ProcessInfo.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.Long.ProcessCenter.ProcessInfo" %>
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="1" width="70%" align="center" border="0">
				...
				<tr>
					<td colSpan="2">
						<div style="HEIGHT: 3px"></div>
						<div>&nbsp;<asp:button id="btnPreApproval" runat="server" Text="Send For Pre-approved"></asp:button></div>
					</td>
				</tr>
				<tr>
					<td colSpan="2">
				...
				<tr>
					<td colSpan="2"><asp:textbox id="ConversationTrack" Width="552px" Runat="server" Height="82px" TextMode="MultiLine"></asp:textbox><asp:button id="btnSave" runat="server" Text="SaveConversation" CssClass="commonImageTextButton"></asp:button>
						<asp:HyperLink id="HyperLink1" runat="server" CssClass="commonImageTextButton" NavigateUrl="ProcessList.aspx">Exit Without Saving</asp:HyperLink></td>
				</tr>
			</table>
		</form>
	</body>
