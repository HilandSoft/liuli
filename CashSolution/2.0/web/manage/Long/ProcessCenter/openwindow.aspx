...
<%@ Page language="c#" Codebehind="openwindow.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.Long.ProcessCenter.openwindow" %>
<HTML>
	<HEAD>
				...
				<tr>
					<td vAlign="top" align="center"><cc1:datagridtable id="DataGridTable1" runat="server" IsAllowPaging="True" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:HyperLinkColumn Text="I have known" DataNavigateUrlField="ProcessID" DataNavigateUrlFormatString="openoperate.aspx?id={0}"
