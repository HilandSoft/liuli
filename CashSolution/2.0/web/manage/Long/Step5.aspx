									...
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td bgColor="#cc3300"><IMG height="30" src="images/step5.gif" width="400">
												<asp:textbox id="txLoanSid" runat="server" Visible="False" Width="79px"></asp:textbox></td>
										</tr>
										<tr>
											<td height="10"></td>
										</tr>
										...
										<tr>
											<td height="15"><asp:label id="Label1" runat="server" Font-Bold="True" ForeColor="Red"></asp:label></td>
										</tr>
										<tr>
