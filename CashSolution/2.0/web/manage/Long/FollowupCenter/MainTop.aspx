<%@ Page language="c#" Codebehind="MainTop.aspx.cs" AutoEventWireup="false" Inherits="YingNet.WeiXing.WebApp.manage.Long.FollowupCenter.MainTop" %>
<HTML>
	<HEAD>
		<title>
			<%=WebAppTitle%>
		...
		*/
		function onClickWndLabel()
		{
			...
			case "a0":
				...
				break;
				case "b0":
				window.parent.window.document.all.main.src = "FollowupStat.aspx";
				break;
			case "c0":
				window.parent.window.document.all.main.src = "FollowupList.aspx?status=0";
				break;
			case "c1":
				window.parent.window.document.all.main.src = "FollowupList.aspx?status=10";
				break;
			case "c2":
				window.parent.window.document.all.main.src = "FollowupList.aspx?status=20";
				break;
				case "c3":
				window.parent.window.document.all.main.src = "FollowupList.aspx?status=30";
				break;
				case "c4":
				window.parent.window.document.all.main.src = "FollowupList.aspx?status=40";
				break;
				case "c5":
				window.parent.window.document.all.main.src = "FollowupList.aspx?status=50";
				break;
				case "c6":
				window.parent.window.document.all.main.src = "FollowupList.aspx?status=60";
				break;
				case "c7":
				window.parent.window.document.all.main.src = "FollowupList.aspx?status=70";
				break;
				case "c8":
				window.parent.window.document.all.main.src = "FollowupList.aspx?status=80";
				break;
				case "c9":
				window.parent.window.document.all.main.src = "FollowupList.aspx?status=90";
				break;
				case "c10":
				window.parent.window.document.all.main.src = "FollowupList.aspx?status=100";
				break;
			}
		}
		</script>
