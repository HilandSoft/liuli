	...
	function showContextMenu(event) {
		...
		//by ct
		oPopup2.show(lefter + 2,topper + 2, width, height+5, foo.document.body)
	...
	function editMe() {
		if (editModeView == false)
		{
			...
			document.getElementById("editTab").src = "/htmleditor/ew_images/status_edit_up.gif"
			document.getElementById("sourceTab").src = "/htmleditor/ew_images/status_source.gif"
			document.getElementById("previewTab").src = "/htmleditor/ew_images/status_preview.gif"
			initFoo()
			foo.focus()
		}
	}
	...
	function sourceMe() {
		if (sourceModeView == false)
		{
			...
			document.getElementById("editTab").src = "/htmleditor/ew_images/status_edit.gif"
			document.getElementById("sourceTab").src = "/htmleditor/ew_images/status_source_up.gif"
			document.getElementById("previewTab").src = "/htmleditor/ew_images/status_preview.gif"
	...
	function previewMe() {
		if (previewModeView == false)
		{
			...
			document.getElementById("editTab").src = "/htmleditor/ew_images/status_edit.gif"
			document.getElementById("sourceTab").src = "/htmleditor/ew_images/status_source.gif"
			document.getElementById("previewTab").src = "/htmleditor/ew_images/status_preview_up.gif"
			previewFrame.focus()
		}
	}
	...
	function toggleTick(tick, state) {
		...
		if(tick.id.indexOf("zoom" + zoomSize + "_") > -1)
		{
			if(state == 1)
			{
				...
				tick.src = '/htmleditor/ew_images/button_tick_inverted.gif'
			}
			else
			{
				// We are over the selected zoom
				tick.src = '/htmleditor/ew_images/button_tick.gif'
			}
		}
	}
		...
		if (isAllowed())
		{
			if (isSelection()) { 
				...
				var topPos = (screen.availHeight-300) / 2 
		 		linkWin = window.open('/htmleditor/insertlink.htm','','width=500,height=300,scrollbars=yes,resizable=yes,titlebar=0,top=' + topPos + ',left=' + leftPos);
			} else
				return
		}
	}
	...
	function doImage() {
		...
		{		
    		...
    		imageWin = window.open(filemanageurl,'','width=540,height=350,scrollbars=yes,resizable=yes,titlebar=0,top=' + topPos + ',left=' + leftPos);
	...
	function ModifyProperties() {
		...
		propWin = window.open('/htmleditor/pageproperties.htm','','width=500,height=450,scrollbars=no,resizable=yes,titlebar=0,top=' + topPos + ',left=' + leftPos);
		}
	}
	...
	function ShowInsertTable() {
		...
		var leftPos = (screen.availWidth-500) / 2
		var topPos = (screen.availHeight-300) / 2 
 		inserttableWin = window.open('/htmleditor/inserttable.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
	...
	function ModifyTable() {
		...
		if (isTableSelected() || isCursorInTableCell()) {
			var leftPos = (screen.availWidth-500) / 2
			var topPos = (screen.availHeight-300) / 2 
	 		modifytableWin = window.open('/htmleditor/modifytable.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
		}
	...
	function ModifyCell() {
		...
		if (isCursorInTableCell()) {
			var leftPos = (screen.availWidth-500) / 2
			var topPos = (screen.availHeight-300) / 2 
	 		modifytableWin = window.open('/htmleditor/modifycell.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
		}
	...
	function modifyForm() {
		...
		if (isCursorInForm()) {
			var leftPos = (screen.availWidth-500) / 2
			var topPos = (screen.availHeight-300) / 2 
	 		modifyFormWin = window.open('/htmleditor/modifyform.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
		}
	...
	function insertForm() {
		if (isAllowed())
		{
			var leftPos = (screen.availWidth-500) / 2
			var topPos = (screen.availHeight-300) / 2 
	 		insertFormWin = window.open('/htmleditor/insertform.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
		}
	}
	...
	function doCustomInserts() {
		if (isAllowed())
		{
			var leftPos = (screen.availWidth-500) / 2
			var topPos = (screen.availHeight-300) / 2 
	 		customInsertWin = window.open('/htmleditor/custominsert.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
		}
	}
	...
	function doAnchor() {
			...
			{
				anchorWin = window.open('/htmleditor/modifyanchor.htm','','width=500,height=250,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
			} else {
	 			anchorWin = window.open('/htmleditor/insertanchor.htm','','width=500,height=250,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
			}
	...
	function doEmail() {
		if (isAllowed())
		{
			if (isSelection()) { 
				var leftPos = (screen.availWidth-500) / 2
				var topPos = (screen.availHeight-300) / 2 
	 			emailWin = window.open('/htmleditor/insertemail.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
			} else
				return
		}
	}
	...
	function ShowFindDialog() {
		if (isAllowed())
		{
		showModelessDialog("/htmleditor/findreplace.htm", foo, "dialogWidth:385px; dialogHeight:165px; scroll:no; status:no; help:no;" );
		}
	}
	...
	function spellCheck(){
		...
		arr = getWords();
	    rng = getRange();
	    spellcheckWin = window.open('/htmleditor/spellcheck.htm', "spellwin", "width=300,height=220,scrollbars=no, top=" + topPos + ",left=" + leftPos);
	}

	function doHelp() {
		var leftPos = (screen.availWidth-500) / 2
		var topPos = (screen.availHeight-400) / 2 
	 	showHelpWin = window.open('/htmleditor/showhelp.htm','','width=500,height=400,scrollbars=yes,resizable=yes,titlebar=0,top=' + topPos + ',left=' + leftPos);
	}
		...
		if (foo.document.selection.type == "Control") {
			...
			if (oControlRange(0).tagName.toUpperCase() == "INPUT") {
				if ((oControlRange(0).type.toUpperCase() == "TEXT") || (oControlRange(0).type.toUpperCase() == "PASSWORD")) {
					...
					textFieldWin = window.open('/htmleditor/modifytextfield.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
				}
				return true;
			}	
		} else {
			textFieldWin = window.open('/htmleditor/inserttextfield.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
		}
		...
		if (foo.document.selection.type == "Control") {
			...
			if (oControlRange(0).tagName.toUpperCase() == "INPUT") {
				if (oControlRange(0).type.toUpperCase() == "HIDDEN") {
					...
					hiddenWin = window.open('/htmleditor/modifyhidden.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
				}
				return true;
			}	
		} else {
			hiddenWin = window.open('/htmleditor/inserthidden.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
		}
	...
	function doTextArea() {
		...
		if (foo.document.selection.type == "Control") {
			...
			if (oControlRange(0).tagName.toUpperCase() == "TEXTAREA") {
					...
					textFieldWin = window.open('/htmleditor/modifytextarea.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
				return true;
			}	
		} else {
			textFieldWin = window.open('/htmleditor/inserttextarea.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
		}
		...
		if (foo.document.selection.type == "Control") {
			...
			if (oControlRange(0).tagName.toUpperCase() == "INPUT") {
				if ((oControlRange(0).type.toUpperCase() == "RESET") || (oControlRange(0).type.toUpperCase() == "SUBMIT") || (oControlRange(0).type.toUpperCase() == "BUTTON")) {
					...
					buttonWin = window.open('/htmleditor/modifybutton.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
				}
				return true;
			}	
		} else {
			buttonWin = window.open('/htmleditor/insertbutton.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
		}
		...
		if (foo.document.selection.type == "Control") {
			...
			if (oControlRange(0).tagName.toUpperCase() == "INPUT") {
				if (oControlRange(0).type.toUpperCase() == "CHECKBOX") {
					...
					checkboxWin = window.open('/htmleditor/modifycheckbox.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
				}
				return true;
			}	
		} else {
			checkboxWin = window.open('/htmleditor/insertcheckbox.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
		}
		...
		if (foo.document.selection.type == "Control") {
			...
			if (oControlRange(0).tagName.toUpperCase() == "INPUT") {
				if (oControlRange(0).type.toUpperCase() == "RADIO") {
					...
					radioWin = window.open('/htmleditor/modifyradio.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
				}
				return true;
			}	
		} else {
			radioWin = window.open('/htmleditor/insertradio.htm','','width=500,height=300,scrollbars=no,resizable=no,titlebar=0,top=' + topPos + ',left=' + leftPos);
		}
