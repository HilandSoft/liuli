...
namespace YingNet.WeiXing.Business
{
	...
	public class HuiyuanBN:BaseLib
	{
		...
		public DataTable GetList (int topCount) 
		{
			if(topCount<=0)
			{
				topCount= 500;
			...
			string topClause= string.Format(" TOP {0} ",topCount);

			DBFieldList = topClause+  " H.DBirth,H.Regtime,H.IsEmployed,H.IsValid,H.id,H.TYears,H.TMonths,H.Param4,H.Param5,H.Param1,H.Param2,H.Param3,H.Mobile,H.Username,H.Password,H.State,H.Postcode,H.HTel,H.RAddress,H.SAddress,H.City,H.Email,H.Issued,H.DNumber,H.Fname,H.Lname,H.Mname,M.NoteContent as Note,M.NodeDesc as followUpHistory";
